...
public class Level4 extends Level {
    ...
    public ImageResource[] getAssets() {
        return ResourceHandler.create1DLoadable(new ImageResource[][]{ResourceHandler.getGolemLoader().getPurpleGolemLoadable(),ResourceHandler.getGolemLoader().getRedGolemLoadable(),ResourceHandler.getGolemLoader().getTallBlueGolemLoadable()});
    }
    ...
    public void update(int subLevel, float deltaTime) {
        ...
        switch (subLevel) {
            ...
            case 2:
                ...
                break;
            case 3:
                HeightMap.setHeights(new HeightVal(0,20,24,true),
                        new HeightVal(36,30,66,false),
                        new HeightVal(77,20,Render.unitsWide,true));
                break;
            case 4:
                HeightMap.setHeights(new HeightVal(0,32,26,true),
    ...
    public void reset() {
        ...
        entityRegister.add(new ShortGolem(ShortGolem.GolemColor.BLUE, 0, 25, 7));
        entityRegister.add(new ShortGolem(ShortGolem.GolemColor.RED, 0, 50, 7));
        entityRegister.add(new ShortGolem(ShortGolem.GolemColor.GREEN, 1, 50, 32));
        entityRegister.add(new ShortGolem(ShortGolem.GolemColor.PURPLE, 2, 24, 31));
        entityRegister.add(new ShortGolem(ShortGolem.GolemColor.GREEN, 3, 52, 30));
        entityRegister.add(new TallGolem(TallGolem.BLUE, 4, 44, 10));
